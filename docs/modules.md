...
This module provides a way to programmatically interact with Wikidata or another Wikibase instance. It is mostly based on [WikibaseIntegrator](https://wikibaseintegrator.readthedocs.io/en/stable/) and requires specific username-password or API keys credentials.
...
- [Transcribe whole document in Transkribus using Kraken][pyreslib.kraken.transcription_dir_to_transkribus]
- [Transcribe single image][pyreslib.kraken.transcribe_image] or [whole directory][pyreslib.kraken.transcribe_directory]
